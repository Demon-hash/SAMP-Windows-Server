...
public OnPlayerDeath(playerid, killerid, reason) {
	...
	(56, '>> Player %s has killed the Human Hero / Queen!', '>> »грок %s убил √еро€(иню)!'),
	(58, '>> Player %s has killed the Zombie Boss / Queen!', '>> »грок %s убил «омби Ѕосса /  оролеву!'),
	(59, '>> [First Blood] Player %s has drawn {FF0000}first blood{FFFFFF} and gains additional %s!', '>> [ѕерва€  ровь] »грок %s {FF0000}пустил первую кровь{FFFFFF} и получил дополниельные %s!'),
	(61, '>> Player %s killed the last survivor and got an additional %s!', '>> »грок %s убил последнего выжившего и получил дополнительные %s!');
